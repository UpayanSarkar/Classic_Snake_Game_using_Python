...
# Managing old pieces of fruit (food)
old_fruit = []
...
# Added a flag to track game over
game_over = False
...
# Keyboard binding to exit the game
screen.onkeypress(exit_game, "Escape")

try:
    while not game_over:
        screen.update() # Update the screen manually to control animation
    ...
    # Handle the case where the user exits with KeyboardInterrupt (Ctrl+C)
    print("Oops! You exited the game.")
except turtle.Terminator:
    # Handle abnormal exits
    print("Abnormal exit detected.")
    pass
finally:
